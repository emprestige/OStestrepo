...
df_input <- read_feather(
  here::here("output", "seasons", "2022-23", "input_infants_subgroup_s7.arrow"))
...
write_feather(df_input, here::here("output", "seasons", "2022-23", "input_manipulated_infants_subgroup_s7.arrow"))
