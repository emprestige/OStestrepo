...
df_input <- read_feather(
  here::here("output", "seasons", "2022-23", "input_children_and_adolescents_s7.arrow"))
...
write_feather(df_input, here::here("output", "seasons", "2022-23", "input_manipulated_children_and_adolescents_s7.arrow"))
