...
study_start_date <- as.Date(study_dates$season7_start_date)
study_end_date <- as.Date(study_dates$season7_end_date)
...
fs::dir_create(here("analysis", "seasons", "2022-23", "dummydata"))
write_feather(dummydata_processed, sink = here("analysis", "seasons", "2022-23", "dummydata", "dummyextract_children_and_adolescents_s7.arrow"))
