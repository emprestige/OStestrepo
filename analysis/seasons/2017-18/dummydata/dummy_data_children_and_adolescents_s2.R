...
study_start_date <- as.Date(study_dates$season2_start_date)
study_end_date <- as.Date(study_dates$season2_end_date)
...
fs::dir_create(here("analysis", "seasons", "2017-18", "dummydata"))
write_feather(dummydata_processed, sink = here("analysis", "seasons", "2017-18", "dummydata", "dummyextract_children_and_adolescents_s2.arrow"))
