...
df_input <- read_feather(
  here::here("output", "seasons", "2017-18", "input_infants_subgroup_s2.arrow"))
...
write_feather(df_input, here::here("output", "seasons", "2017-18", "input_manipulated_infants_subgroup)s2.arrow"))
