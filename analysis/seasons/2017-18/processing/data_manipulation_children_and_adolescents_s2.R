...
df_input <- read_feather(
  here::here("output", "seasons", "2017-18", "input_children_and_adolescents_s2.arrow"))
...
write_feather(df_input, here::here("output", "seasons", "2017-18", "input_manipulated_children_and_adolescents_s2.arrow"))
