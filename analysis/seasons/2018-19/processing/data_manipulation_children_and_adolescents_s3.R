...
df_input <- read_feather(
  here::here("output", "seasons", "2018-19", "input_children_and_adolescents_s3.arrow"))
...
write_feather(df_input, here::here("output", "seasons", "2018-19", "input_manipulated_children_and_adolescents_s3.arrow"))
