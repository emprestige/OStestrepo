...
study_start_date <- as.Date(study_dates$season3_start_date)
study_end_date <- as.Date(study_dates$season3_end_date)
...
fs::dir_create(here("analysis", "seasons", "2018-19", "dummydata"))
write_feather(dummydata_processed, sink = here("analysis", "seasons", "2018-19", "dummydata", "dummyextract_children_and_adolescents_s3.arrow"))
