...
df_input <- read_feather(
  here::here("output", "seasons", "2019-20", "input_infants_subgroup_s4.arrow"))
...
write_feather(df_input, here::here("output", "seasons", "2019-20", "input_manipulated_infants_subgroup_s4.arrow"))
