...
df_input <- read_feather(
  here::here("output", "seasons", "2019-20", "input_children_and_adolescents_s4.arrow"))
...
write_feather(df_input, here::here("output", "seasons", "2019-20", "input_manipulated_children_and_adolescents_s4.arrow"))
