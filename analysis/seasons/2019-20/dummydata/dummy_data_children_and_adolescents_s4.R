...
study_start_date <- as.Date(study_dates$season4_start_date)
study_end_date <- as.Date(study_dates$season4_end_date)
...
fs::dir_create(here("analysis", "seasons", "2019-20", "dummydata"))
write_feather(dummydata_processed, sink = here("analysis", "seasons", "2019-20", "dummydata", "dummyextract_children_and_adolescents_s4.arrow"))
