...
fs::dir_create(here("analysis", "seasons", "2016-17", "dummydata"))
write_feather(dummydata_processed, sink = here("analysis", "seasons", "2016-17", "dummydata", "dummyextract_children_and_adolescents_s1.arrow"))
