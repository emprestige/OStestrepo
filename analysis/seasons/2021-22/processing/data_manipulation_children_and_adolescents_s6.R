...
df_input <- read_feather(
  here::here("output", "seasons", "2021-22", "input_children_and_adolescents_s6.arrow"))
...
write_feather(df_input, here::here("output", "seasons", "2021-22", "input_manipulated_children_and_adolescents_s6.arrow"))
