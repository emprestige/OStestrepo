...
df_input <- read_feather(
  here::here("output", "seasons", "2021-22", "input_infants_subgroup_s6.arrow"))
...
write_feather(df_input, here::here("output", "seasons", "2021-22", "input_manipulated_infants_subgroup_s6.arrow"))
