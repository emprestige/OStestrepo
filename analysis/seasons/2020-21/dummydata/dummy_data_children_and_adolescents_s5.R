...
study_start_date <- as.Date(study_dates$season5_start_date)
study_end_date <- as.Date(study_dates$season5_end_date)
...
fs::dir_create(here("analysis", "seasons", "2020-21", "dummydata"))
write_feather(dummydata_processed, sink = here("analysis", "seasons", "2020-21", "dummydata", "dummyextract_children_and_adolescents_s5.arrow"))
