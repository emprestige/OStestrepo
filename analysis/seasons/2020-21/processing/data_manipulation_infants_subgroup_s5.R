...
df_input <- read_feather(
  here::here("output", "seasons", "2020-21", "input_infants_subgroup_s5.arrow"))
...
write_feather(df_input, here::here("output", "seasons", "2020-21", "input_manipulated_infants_subgroup_s5.arrow"))
